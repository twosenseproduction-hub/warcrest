...
function loadRig(){ return new Promise(res=>{
  ...
  const MDLV='?v=14';   // asset cache-buster — bump on any model/texture change so /assets max-age=86400 doesn't pin a stale rig (index.html revalidates, so a new ?v reaches clients at once)
