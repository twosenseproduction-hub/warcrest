...
(function (root) {
  ...
  LPF.lighting = {
    rig: function (scene, renderer) {
      ...
      var key = new THREE.DirectionalLight(0xfff2dd, 0.95); key.position.set(5, 8, 4);
      ...
      var fill = new THREE.HemisphereLight(0xbcd3ff, 0x3a2d4a, 0.22);
      var rim = new THREE.DirectionalLight(0x9ad8ff, 0.4); rim.position.set(-4, 3, -5);
