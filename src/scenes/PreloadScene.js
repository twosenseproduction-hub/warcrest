...
export class PreloadScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.tilemapTiledJSON('tideland_crossing', 'assets/maps/tideland-crossing.tmj?v=20260627d');
    ...
    this.load.json('tmjdata:tideland_crossing', 'assets/maps/tideland-crossing.tmj?v=20260627d');
  }
