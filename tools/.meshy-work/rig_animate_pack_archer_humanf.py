#!/usr/bin/env python3
"""DIY rig + animate pack-ready Meshy elven archer on HumanF pack skeleton.
...
REPO = Path("/workspace")
RAW = REPO / "assets/models/meshy/pack_archer_meshy.glb"
...
OUT_RIG = REPO / "assets/models/meshy/pack_archer_meshy_rigged.glb"
OUT_ANIM = REPO / "assets/models/meshy/pack_archer_meshy_pack_anim.glb"
TARGET_FACES = 50000
HEIGHT = 1.7
